...
import {
  ...
  requestWithdrawal, notifyCopyEvent,
...
// The single real entry point. The business dashboard (pay.tranxact.co) and
// public storefront platform (business.tranxact.co) have been removed —
// every visitor, on any host, gets the consumer app. TranxactPay checkout
// links (/pay/{slug}) still work as before, handled inside MobileAppRoot.
